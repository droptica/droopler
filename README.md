...
## How to upgrade Droopler from 3.3.x to 3.4.x for Drupal 11

1. Run `composer require droptica/droopler:dev-prereq-3.4.0-alpha --with-all-dependencies`.
2. Run `drush updb`.
3. Run `drush cr`.
4. Run `composer require droptica/droopler:dev-3.4.0-alpha --no-update`.
